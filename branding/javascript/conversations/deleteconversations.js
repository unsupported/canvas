...
// not discriminate between any user role, enrollment, or user type. It loads a list of conversations (on every page load) and attempts
// to delete them. Over time, it will delete all conversations for every user as long as the users are in Canvas.
