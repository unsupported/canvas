...
#To set course(s) visibility to "Course":
  ...
  #Only those who are enrolled AND authenticated will see course materials

#To set course(s) visibility to "Institution":
  #Set @public_visibility=false and @institution_visibility=true
  #Anyone who is authenticated will see course materials

#To set course(s) visibility to "Public":
  #Set @public_visibility=true
  #CAVEAT:
    #If @public_visibility=true BUT @institution_visibility=false:
      #ONLY enrolled users and UNauthenticated users will see course materials
      #Users who are authenticated but not enrolled won't see course materials
    #If @public_visibility=true AND @institution_visibility=true:
      #Anyone can view course materials under these conditions.
    ...
    response = Typhoeus.put(
            ...
            body: {
                course: {
                  ...
                  :is_public_to_auth_users => @institution_visibility
                }
            }
        )
